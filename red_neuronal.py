...
model=keras.models.Sequential([keras.layers.Dense(25,activation=tf.nn.relu,input_shape=(input_dim,)),keras.layers.Dense(25,activation=tf.nn.relu), keras.layers.Dense(output_dim)])
